...
<html lang="pt-BR">
<head>
  <title>Ideias Cadastradas</title>
  <meta charset="utf-8">
    ...
    <div class="card-body">
      <div class="container">
        <ul>
          ...
          <br>
          <?php 
              $select = "SELECT repositorio_de_ideia_id, repositorio_de_ideia_nome FROM repositorios_de_ideias";
              $result = mysqli_query($conn, $select);
              while($fetch = mysqli_fetch_row($result)){
                  echo "<a href=repositorios.php?repositorio_de_ideia_id=".$fetch[0]."><h5>$fetch[1]</h5>";
              }
